    ...
    return (
        <div className='future'>
            ...
            <div className='daily-container'>
                {props.forecastWeather.forecast[0].day.map((day: any, index: any) => (
                    <div key={day}>
                        <hr></hr>
                        <div className='daily-row'>
                            <p>{day}</p>
                            <p>{props.forecastWeather.forecast[1].icon[index]}</p>
                            <p>{props.forecastWeather.forecast[2].high[index]}</p>
                            <p>{props.forecastWeather.forecast[3].low[index]}</p>
                            <p>{props.forecastWeather.forecast[4].description[index]}</p>
                            <p>{props.forecastWeather.forecast[5].precipitation[index]}</p>
